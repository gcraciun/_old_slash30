...
echo '
<form action="newsmall.php" method="post">
...
echo'
    ...
    <tr align="center" valign="center">
      <td>';
	//cauta_clasa($big_id);
	$clasa_libera = cauta_clasa($big_id);
	echo "$clasa_libera";
	//print cauta_clasa($big_id);
echo '
      </td>
      <td><input type="button" name="Adauga" value="Adauga" onClick="location.href = \'add.php?clasa_libera='.$clasa_libera.'&parent='.$big_id.'\'"></td>
    </tr>
  </tbody>
</table>
</form>
